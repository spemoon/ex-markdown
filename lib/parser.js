...
Parser.prototype.tok = function() {
    switch(this.token.type) {
        ...
        case 'section':
        {
            ...
            var rule = ['method', 'api', 'url', 'response', 'desc', 'params'];
            var reg = /(?: *\- *(method|api|url|response|desc|params) *: *)/g;
            ...
            while(arr.length) {
                ...
                if(item) {
                    if(item === 'method') {
                        ...
                        data[item] = '<div class="api-url">' + arr.shift() + '</div>';
                    } else if(item === 'response') {
                        data[item] = '<div class="api-response">' + this.renderer.code(arr.shift(), 'json', this.token.escaped) + '</div>';
                    } else if(item === 'desc') {
            ...
            var html = '<header>' + data.method + data.api + '</header>' + data.response + data.desc + data.params
